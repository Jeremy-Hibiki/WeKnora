export default {
  ...
  knowledgeBase: {
    ...
    batchTag: 'Batch Tags',
    batchTagAppendMode: 'Append Mode',
    batchTagAppendTip: 'Selected tags will be appended to existing tags of each document, preserving original tags',
  ...
  uploadConfirm: {
    ...
    tabTags: 'Tags',
    tagsNone: 'None selected',
    tagsSelect: 'Select tags',
...
\
  ...
  userManagement: {
    ...
    subtitle: 'Manage all platform users: create accounts, disable, and reset passwords. System admins only.',
    ...
    resetDialog: {
      ...
      warning: 'A new password will be set for {email}; all of their existing sessions will be revoked immediately and they will need to sign in again with the new password.',
    },
    disableDialog: {
      title: 'Disable user',
      warning: 'Once disabled, “{name}” cannot sign in and all existing sessions are revoked immediately. You can re-enable them at any time.',
    },
    messages: {
  ...
  datasource: {
    ...
    connectorDesc: {
      ...
      svn: 'Sync documents from SVN repositories',
    },
    field: {
      appId: 'App ID',
      ...
      repoUrlHint: 'Supports svn://, http(s):// and svn+ssh:// schemes',
      svnUsername: 'Username (optional)',
  ...
  tagByFolder: {
    title: 'Tag Folder',
    menuLabel: 'Tag Folder',
    affectedCount: '{count} documents will be affected',
    counting: 'Counting documents...',
    actionLabel: 'Action',
    addAction: 'Add Tags',
    removeAction: 'Remove Tags',
    recursiveLabel: 'Include subfolders',
    recursiveHint: 'Process documents in all descendant subfolders',
    tagPickerLabel: 'Select Tags',
    searchPlaceholder: 'Search tags...',
    noTagsFound: 'No matching tags found',
    createTag: 'Create tag "{name}"',
    pointInTimeWarning: 'This operation only affects documents currently in the folder. Documents added later will NOT automatically receive these tags.',
    scopeChangeWarning: 'Adding or removing tags immediately affects retrieval scope for sessions and agents using these tags.',
