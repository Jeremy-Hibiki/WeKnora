export default {
  ...
  uploadConfirm: {
    ...
    tabTags: 'Теги',
    tagsNone: 'Не выбрано',
    tagsSelect: 'Выбрать теги',
    tagSearch: 'Поиск тегов',
...
/example\.(net|org)/`,
  ...
  userManagement: {
    ...
    subtitle: 'Управление всеми пользователями платформы: создание учётных записей, отключение и сброс паролей. Только для системных администраторов.',
    ...
    resetDialog: {
      ...
      warning: 'Для {email} будет установлен новый пароль; все существующие сеансы будут немедленно отозваны, потребуется войти снова с новым паролем.',
    },
    disableDialog: {
      title: 'Отключить пользователя',
      warning: 'После отключения «{name}» не сможет войти, а все существующие сеансы будут немедленно отозваны. Можно снова включить в любое время.',
    },
    messages: {
      ...
      enableSuccess: 'Пользователь включён',
      enableFailed: 'Не удалось включить пользователя',
      disableSuccess: 'Пользователь отключён',
      disableFailed: 'Не удалось отключить пользователя',
    },
  },
  system: {
  ...
  datasource: {
    ...
    connectorDesc: {
      ...
      svn: 'Синхронизация документов из SVN репозиториев',
    },
    field: {
      appId: 'App ID',
      ...
      repoUrlHint: 'Поддерживаются протоколы svn://, http(s)://, svn+ssh://',
      svnUsername: 'Имя пользователя (необязательно)',
      svnPassword: 'Пароль',
    },
    comingSoon: 'Скоро',
  ...
  knowledgeFolder: {
    ...
    renameFolderSuccess: 'Папка переименована',
    ...
    selectTargetFolder: 'Выберите целевую папку',
    moveToFolder: 'Переместить в папку',
    uploadToFolder: 'Загрузить в {folder}',
    ...
    noFolders: 'Нет папок',
    selectKBFirst: 'Сначала выберите базу знаний',
    folderCreatedSuccess: 'Папка успешно создана',
    folderCreatedFailed: 'Не удалось создать папку',
    folderUpdatedSuccess: 'Папка успешно обновлена',
    folderUpdatedFailed: 'Не удалось обновить папку',
    folderDeletedSuccess: 'Папка удалена',
    folderDeletedFailed: 'Не удалось удалить папку',
    folderMovedSuccess: 'Папка перемещена',
    folderMovedFailed: 'Не удалось переместить папку',
    confirmDeleteFolder: 'Вы уверены, что хотите удалить папку «{name}»?',
    confirmDeleteFolderWithContent: 'Папка «{name}» содержит {count} элементов. Вы уверены, что хотите удалить её?',
    forceDelete: 'Принудительное удаление (включая всё содержимое)',
    batchMoveSuccess: 'Перемещено файлов: {count}',
    batchMoveFailed: 'Не удалось выполнить массовое перемещение',
    viewModeList: 'Список',
    viewModeGrid: 'Сетка',
    navigationHint: 'Двойной щелчок, чтобы войти в папку',
    selectFolderHint: 'Выберите целевую папку или «Корневую папку» для перемещения на верхний уровень',
    folderPathSeparator: ' / ',
    loading: 'Загрузка...',
    loadingFolders: 'Загрузка папок...',
    loadingBreadcrumb: 'Загрузка пути...',
    cannotMoveToSelf: 'Нельзя переместить в саму себя или её подпапку',
    cannotMoveToDescendant: 'Нельзя переместить в собственную подпапку',
    folderNameRequired: 'Введите имя папки',
    folderNameTooLong: 'Имя папки не может превышать 255 символов',
  ...
  tagByFolder: {
    title: 'Тегировать папку',
    menuLabel: 'Тегировать папку',
    affectedCount: 'Будут затронуты {count} документов',
    counting: 'Подсчёт документов...',
    actionLabel: 'Действие',
    addAction: 'Добавить теги',
    removeAction: 'Удалить теги',
    recursiveLabel: 'Включая подпапки',
    recursiveHint: 'Обрабатывать документы во всех вложенных подпапках',
    tagPickerLabel: 'Выбрать теги',
    searchPlaceholder: 'Поиск тегов...',
    noTagsFound: 'Теги не найдены',
    createTag: 'Создать тег "{name}"',
    pointInTimeWarning: 'Эта операция влияет только на документы, находящиеся в папке на данный момент. Документы, добавленные позже, НЕ получат эти теги автоматически.',
    scopeChangeWarning: 'Добавление или удаление тегов немедленно влияет на область поиска для сессий и агентов, использующих эти теги.',
