export default {
  ...
  knowledgeBase: {
    ...
    clearSelection: "取消选择",
    batchTag: "批量改标签",
    batchTagAppendMode: "追加模式",
    batchTagAppendTip: "本次选择的标签将追加到各文档已有标签中，原有标签保持不变",
    batchDelete: "批量删除",
  ...
  userManagement: {
    title: "用户管理",
    subtitle: "管理平台全部用户：创建账号、停用、重置密码。仅系统管理员可访问。",
    ...
    resetDialog: {
      title: "重置“{name}”的密码",
      warning: "将为 {email} 设置新密码，该用户的所有现有会话将立即失效，需要使用新密码重新登录。",
    },
    disableDialog: {
      title: "停用用户",
      warning: "停用后，“{name}”将无法登录，其所有现有会话也会立即失效。可随时重新启用。",
    },
    messages: {
      loadFailed: "加载用户列表失败",
  ...
  datasource: {
    ...
    field: {
      ...
      repoUrl: "仓库地址",
      repoUrlHint: "支持 svn://、http(s)://、svn+ssh:// 协议",
      svnUsername: "用户名（可选）",
      svnPassword: "密码",
    },
    comingSoon: "即将支持",
  ...
  tagByFolder: {
    title: "文件夹打标签",
    menuLabel: "文件夹打标签",
    affectedCount: "将影响 {count} 个文档",
    counting: "正在统计文档数...",
    actionLabel: "操作方式",
    addAction: "添加标签",
    removeAction: "移除标签",
    recursiveLabel: "包含子文件夹",
    recursiveHint: "递归地处理所有子文件夹中的文档",
    tagPickerLabel: "选择标签",
    searchPlaceholder: "搜索标签...",
    noTagsFound: "未找到匹配的标签",
    createTag: "创建标签 \"{name}\"",
    pointInTimeWarning: "此操作仅影响当前文件夹中的文档。之后新增的文档不会自动获得这些标签。",
    scopeChangeWarning: "添加或移除标签会立即影响正在使用这些标签的会话和智能体的检索范围。",
    confirmAdd: "确认添加",
    confirmRemove: "确认移除",
    success: "操作成功",
  },
