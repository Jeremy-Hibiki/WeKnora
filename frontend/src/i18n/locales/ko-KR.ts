export default {
  ...
  userManagement: {
    title: "사용자 관리",
    subtitle: "플랫폼의 모든 사용자 관리: 계정 생성, 비활성화, 비밀번호 재설정. 시스템 관리자 전용.",
    ...
    resetDialog: {
      title: "“{name}”의 비밀번호 재설정",
      warning: "{email}의 새 비밀번호가 설정됩니다. 기존 세션은 즉시 만료되며, 새 비밀번호로 다시 로그인해야 합니다.",
    },
    disableDialog: {
      title: "사용자 비활성화",
      warning: "비활성화하면 “{name}”은(는) 로그인할 수 없으며, 모든 기존 세션이 즉시 만료됩니다. 언제든 다시 활성화할 수 있습니다.",
    },
    messages: {
      ...
      enableSuccess: "사용자가 활성화되었습니다",
      enableFailed: "사용자 활성화에 실패했습니다",
      disableSuccess: "사용자가 비활성화되었습니다",
      disableFailed: "사용자 비활성화에 실패했습니다",
    },
  },
  ...
  datasource: {
    ...
    field: {
      ...
      repoUrl: "저장소 주소",
      repoUrlHint: "svn://, http(s)://, svn+ssh:// 프로토콜 지원",
      svnUsername: "사용자 이름 (선택)",
      svnPassword: "비밀번호",
    },
    comingSoon: "곧 지원 예정",
  ...
  knowledgeFolder: {
    ...
    renameFolderSuccess: "폴더 이름이 변경되었습니다",
    ...
    folderDescriptionPlaceholder: "폴더 설명을 입력하세요 (선택 사항)",
    selectFolder: "폴더 선택",
    selectTargetFolder: "대상 폴더 선택",
    moveToFolder: "폴더로 이동",
    uploadToFolder: "{folder}에 업로드",
    currentFolder: "현재 폴더",
    parentFolder: "상위 폴더",
    subfolders: "하위 폴더",
    ...
    noFolders: "폴더가 없습니다",
    selectKBFirst: "먼저 지식 베이스를 선택하세요",
    folderCreatedSuccess: "폴더가 생성되었습니다",
    folderCreatedFailed: "폴더 생성에 실패했습니다",
    folderUpdatedSuccess: "폴더가 업데이트되었습니다",
    folderUpdatedFailed: "폴더 업데이트에 실패했습니다",
    folderDeletedSuccess: "폴더가 삭제되었습니다",
    folderDeletedFailed: "폴더 삭제에 실패했습니다",
    folderMovedSuccess: "폴더가 이동되었습니다",
    folderMovedFailed: "폴더 이동에 실패했습니다",
    confirmDeleteFolder: '"{name}" 폴더를 삭제하시겠습니까?',
    confirmDeleteFolderWithContent: '"{name}" 폴더에 {count}개 항목이 있습니다. 정말 삭제하시겠습니까?',
    forceDelete: "강제 삭제 (모든 콘텐츠 포함)",
    batchMoveSuccess: "{count}개 파일이 이동되었습니다",
    batchMoveFailed: "일괄 이동에 실패했습니다",
    viewModeList: "목록 보기",
    viewModeGrid: "바둑판 보기",
    navigationHint: "폴더를 두 번 클릭하여 열기",
    selectFolderHint: "대상 폴더를 선택하거나, 최상위로 이동하려면 \"루트 폴더\"를 선택하세요",
    folderPathSeparator: " / ",
    loading: "로딩 중...",
    loadingFolders: "폴더 로딩 중...",
    loadingBreadcrumb: "경로 로딩 중...",
    cannotMoveToSelf: "자기 자신이나 하위 폴더로 이동할 수 없습니다",
    cannotMoveToDescendant: "자신의 하위 폴더로 이동할 수 없습니다",
    folderNameRequired: "폴더 이름을 입력하세요",
    folderNameTooLong: "폴더 이름은 255자를 초과할 수 없습니다",
  ...
  tagByFolder: {
    title: "폴더 태그 지정",
    menuLabel: "폴더 태그 지정",
    affectedCount: "{count}개 문서가 영향을 받습니다",
    counting: "문서 수 계산 중...",
    actionLabel: "작업",
    addAction: "태그 추가",
    removeAction: "태그 제거",
    recursiveLabel: "하위 폴더 포함",
    recursiveHint: "모든 하위 폴더의 문서를 처리합니다",
    tagPickerLabel: "태그 선택",
    searchPlaceholder: "태그 검색...",
    noTagsFound: "일치하는 태그가 없습니다",
    createTag: "태그 \"{name}\" 만들기",
    pointInTimeWarning: "이 작업은 현재 폴더의 문서에만 영향을 미칩니다. 나중에 추가된 문서는 자동으로 태그를 받지 않습니다.",
    scopeChangeWarning: "태그 추가 또는 제거는 이 태그를 사용하는 세션과 에이전트의 검색 범위에 즉시 영향을 미칩니다.",
    confirmAdd: "추가 확인",
    confirmRemove: "제거 확인",
    success: "작업이 완료되었습니다",
  },
