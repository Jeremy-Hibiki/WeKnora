...
func (s *customAgentService) GetSuggestedQuestions(
	...
	return s.getSuggestedQuestions(ctx, agentID, kbIDs, knowledgeIDs, tagIDs, folderIDs, includeSubfolders, limit, true)
}
...
func (s *customAgentService) GetKnowledgeSuggestedQuestions(
	...
	return s.getSuggestedQuestions(ctx, agentID, kbIDs, knowledgeIDs, tagIDs, nil, false, limit, false)
}
