# llm-scoped-search Specification

## Purpose
Exposes folder/tag scoping and folder/tag discovery to LLM callers (agent tool + MCP), using human-readable names resolved server-side to internal IDs.
